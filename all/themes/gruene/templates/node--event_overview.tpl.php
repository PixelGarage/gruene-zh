...
<div class="middle">
	...
	<div class="title-container <?php print $type; ?>">
		...
		<?php if (isset($node->field_event_overview_image) && !empty($node->field_event_overview_image['und'][0]['uri'])): ?>
			<div class="title-image" style="background-image:url(<?php print file_create_url($node->field_event_overview_image['und'][0]['uri']); ?>);"></div>
		<?php endif; ?>
	...
	<div class="views-container <?php print $type; ?>">
		<?php
			print views_embed_view('event_view', $display_id = 'default');
		?>
